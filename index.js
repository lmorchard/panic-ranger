...
var Component = function () {
  ...
  createClass(Component, null, [{
    ...
    value: function create(attrs) {
      return index(attrs || {}, this.defaults());
    }
  }]);
  return Component;
}();
...
var System = function () {
  function System(options) {
    ...
    this.options = index(options || {}, this.defaultOptions());
...
var ViewportCanvas = function (_Core$System) {
  inherits(ViewportCanvas, _Core$System);

  function ViewportCanvas() {
    classCallCheck(this, ViewportCanvas);
    return possibleConstructorReturn(this, (ViewportCanvas.__proto__ || Object.getPrototypeOf(ViewportCanvas)).apply(this, arguments));
  }

  createClass(ViewportCanvas, [{
    key: 'defaultOptions',
    value: function defaultOptions() {
      return {
        lineWidth: 1.5,
...
registerSystem('ViewportCanvas', ViewportCanvas);
