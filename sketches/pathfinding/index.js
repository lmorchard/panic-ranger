...
module.exports = __webpack_require__(/*! ./src/sketches/pathfinding.js */189);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(/*! lodash */ 190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plugins_expiration__ = __webpack_require__(/*! ../plugins/expiration */ 85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__plugins_steering__ = __webpack_require__(/*! ../plugins/steering */ 99);
...
throw new Error("Cannot find module \"../plugins/pathfinding\"");
...
function spawnField(centerX, centerY) {
  ...
  var vCenter = new __WEBPACK_IMPORTED_MODULE_2__lib_Vector2D__["a" /* default */](centerY, centerX);
  var vSpawn = new __WEBPACK_IMPORTED_MODULE_2__lib_Vector2D__["a" /* default */](0, 0);
  var vGrav = new __WEBPACK_IMPORTED_MODULE_2__lib_Vector2D__["a" /* default */](0, 0);
  var inField = [];

  for (var idx = 0; idx < MAX_ASTEROIDS; idx++) {
    for (var c = 0; c < MAX_TRIES; c++) {

      var size = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.random(MIN_SIZE, MAX_SIZE);
      var rot = Math.PI * 4 * Math.random();
      vSpawn.setValues(vCenter.x, vCenter.y - __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.random(1, radius));
...
world.subscribe(__WEBPACK_IMPORTED_MODULE_0__lib_core__["Messages"].ENTITY_DESTROY, function () /*msg, data*/{
  spawnEnemy();
});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 191), __webpack_require__(/*! ./../webpack/buildin/module.js */ 192)(module)))
