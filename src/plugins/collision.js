...
let entityId, matches, sprite, position;
...
export class CollisionSystem extends Core.System {
  ...
  checkCollision(bCollidable, aCollidable) {
    ...
    const dx = aCollidable.position.x - bCollidable.position.x;
    const dy = aCollidable.position.y - bCollidable.position.y;
    ...
    */
    ...
    const radii = (aCollidable.sprite.size + bCollidable.sprite.size) / 2;
